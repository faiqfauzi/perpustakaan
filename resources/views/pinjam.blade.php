        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Nama</label>
                        <input type="text" value="{{ $d->nama_pinjam }}" class="form-control" name="nama_pinjam" placeholder="Nama Buku" readonly>
                    </div>
                    <div class="form-group">
                        <label>Nomor HP</label>
                        <input type="text" value="{{ $d->nomor_hp }}" class="form-control" name="nomor_hp" placeholder="Penerbit" readonly>
                    </div>
                    <div class="form-group">
                        <label>Status</label>
